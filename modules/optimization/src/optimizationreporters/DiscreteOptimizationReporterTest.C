...
//**********************
#include "DiscreteOptimizationReporterTest.h"
// #include "FEProblem.h"
// #include "MooseMesh.h"
...
//*************************
InputParameters
DiscreteOptimizationReporterTest::validParams()
{
  InputParameters params = GeneralReporter::validParams();

  params.addClassDescription(
      "Receives computed objective function, and contains reporters for "
      "communicating between CustomOptimizeSolve and subapps. For testing purposes.");
...
// Class Constructor
//*******************
DiscreteOptimizationReporterTest::DiscreteOptimizationReporterTest(
...
void
DiscreteOptimizationReporterTest::isMaterialAllowed(const MooseMesh & domain_mesh)
{
...
void
DiscreteOptimizationReporterTest::getOptimizationDomain(const MooseMesh & domain_mesh)
{
...
void
DiscreteOptimizationReporterTest::setInitialCondition(const MooseMesh & domain_mesh)
{
  if (!_fe_problem.hasMultiApps())
  {
...
// the domain.
void
DiscreteOptimizationReporterTest::testUpdateSubdomainID(
...
void
DiscreteOptimizationReporterTest::updateSubdomainID(
    const std::vector<subdomain_id_type> allowed_parameter_values,
...
void
DiscreteOptimizationReporterTest::printCurrentDomain(const dof_id_type & iteration)
{
  std::ofstream file;
  std::string fileName;
...
std::tuple<std::vector<subdomain_id_type> &,
           ...
           std::map<dof_id_type, subdomain_id_type> &>
DiscreteOptimizationReporterTest::getMeshParameters()
{
...
unsigned int
DiscreteOptimizationReporterTest::costFunctionTest(
...
// Function to calculate the cost of a given Domain
unsigned int
DiscreteOptimizationReporterTest::costFunction(
    const MooseMesh & domain_mesh, const std::map<dof_id_type, subdomain_id_type> & domain_map)
{
  unsigned int total_cost = 0;
...
void
DiscreteOptimizationReporterTest::printMap(
